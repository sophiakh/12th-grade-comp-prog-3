...
public class Card extends JPanel{
		...
		public Card(int value, Suit suit) {
			...
			try {
			    ...
			    File img = new File("D:\\Solitaire\\solitaire\\images\\cards\\" + this.toString() + ".png");
			    image = ImageIO.read(img); 
				// Load the backImage
			    img = new File("D:\\Solitaire\\solitaire\\images\\cards\\back.png");
				backImage = ImageIO.read(img );
